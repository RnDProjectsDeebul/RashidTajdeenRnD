...
checkpoint = torch.load('output/movie_classifier/model.pth')
# load model weights state_dict
model.load_state_dict(checkpoint['model_state_dict'])
model.eval()

train_csv = pd.read_csv('input/movie_classifier/Multi_Label_dataset/train.csv')
...
for counter, data in enumerate(test_loader):
    ...
    plt.savefig(f"output/movie_classifier/inference_{counter}.jpg")
